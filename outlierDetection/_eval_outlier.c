...
static PyObject *__pyx_n_s_true_mem_size;
...
static PyObject *__pyx_pw_16outlierDetection_13_eval_outlier_1evaluate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_userId,&__pyx_n_s_history,&__pyx_n_s_historyLen,&__pyx_n_s_targetObjId,&__pyx_n_s_Theta_zh,&__pyx_n_s_Psi_sz,&__pyx_n_s_env,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_userId)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_history)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 1); __PYX_ERR(0, 4, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_historyLen)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 2); __PYX_ERR(0, 4, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_targetObjId)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 3); __PYX_ERR(0, 4, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Theta_zh)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 4); __PYX_ERR(0, 4, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Psi_sz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 5); __PYX_ERR(0, 4, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_env)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 6); __PYX_ERR(0, 4, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "evaluate") < 0)) __PYX_ERR(0, 4, __pyx_L3_error)
      }
    ...
    __pyx_v_userId = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_userId == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_history = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1]); if (unlikely(!__pyx_v_history.memview)) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_historyLen = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_historyLen == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_targetObjId = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_targetObjId == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_Theta_zh = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[4]); if (unlikely(!__pyx_v_Theta_zh.memview)) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_Psi_sz = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[5]); if (unlikely(!__pyx_v_Psi_sz.memview)) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_env = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_env == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("outlierDetection._eval_outlier.evaluate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16outlierDetection_13_eval_outlier_evaluate(__pyx_self, __pyx_v_userId, __pyx_v_history, __pyx_v_historyLen, __pyx_v_targetObjId, __pyx_v_Theta_zh, __pyx_v_Psi_sz, __pyx_v_env);
...
static PyObject *__pyx_pw_16outlierDetection_13_eval_outlier_3calculateSequenceProb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("calculateSequenceProb (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_theSequence)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16outlierDetection_13_eval_outlier_2calculateSequenceProb(__pyx_self, __pyx_v_theSequence, __pyx_v_theSequenceLen, __pyx_v_true_mem_size, __pyx_v_userId, __pyx_v_Theta_zh, __pyx_v_Psi_sz);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_true_mem_size, __pyx_k_true_mem_size, sizeof(__pyx_k_true_mem_size), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_eval_outlier(void); /*proto*/
PyMODINIT_FUNC init_eval_outlier(void)
#else
PyMODINIT_FUNC PyInit__eval_outlier(void); /*proto*/
PyMODINIT_FUNC PyInit__eval_outlier(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__eval_outlier(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_eval_outlier", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "outlierDetection._eval_outlier")) {
      if (unlikely(PyDict_SetItemString(modules, "outlierDetection._eval_outlier", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
