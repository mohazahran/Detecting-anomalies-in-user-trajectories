...
static const char __pyx_k_bsp[] = "_bsp";
...
static const char __pyx_k_tribeflow_sorting_binsearch[] = "tribeflow.sorting.binsearch";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_strided_and_direct_or_indirect[] = "<strided and direct or indirect>";
static const char __pyx_k_home_zahran_Desktop_tribeFlow_t[] = "/home/zahran/Desktop/tribeFlow/tribeFlow_new/tribeflow/sorting/binsearch.pyx";
...
static PyObject *__pyx_pw_9tribeflow_7sorting_9binsearch_1_bsp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_bsp (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_value)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_bsp", 1, 2, 2, 1); __PYX_ERR(0, 36, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_bsp") < 0)) __PYX_ERR(0, 36, __pyx_L3_error)
      }
    ...
    __pyx_v_array = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0]); if (unlikely(!__pyx_v_array.memview)) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_value = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_value == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_bsp", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 36, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  ...
  __pyx_t_1 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_f_9tribeflow_7sorting_9binsearch_bsp((&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_array.data) + __pyx_t_1)) )))), __pyx_v_value, (__pyx_v_array.shape[0]))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
 ...
 *     return bsp(&array[0], value, array.shape[0])
 */
  __pyx_tuple__14 = PyTuple_Pack(2, __pyx_n_s_array, __pyx_n_s_value); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(2, 0, 2, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_zahran_Desktop_tribeFlow_t, __pyx_n_s_bsp, 36, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 36, __pyx_L1_error)
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "tribeflow.sorting.binsearch")) {
      if (unlikely(PyDict_SetItemString(modules, "tribeflow.sorting.binsearch", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("bsp", (void (*)(void))__pyx_f_9tribeflow_7sorting_9binsearch_bsp, "int (double *, double, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
 ...
 *     return bsp(&array[0], value, array.shape[0])
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9tribeflow_7sorting_9binsearch_1_bsp, NULL, __pyx_n_s_tribeflow_sorting_binsearch); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_bsp, __pyx_t_1) < 0) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
