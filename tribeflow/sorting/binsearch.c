...
#define __PYX_HAVE__tribeflow__sorting__binsearch
#define __PYX_HAVE_API__tribeflow__sorting__binsearch
#include "pythread.h"
#include "string.h"
#include "stdlib.h"
#include "stdio.h"
...
static const char *__pyx_f[] = {
  "tribeflow/sorting/binsearch.pyx",
  "stringsource",
};
...
#define __Pyx_MODULE_NAME "tribeflow.sorting.binsearch"
int __pyx_module_is_main_tribeflow__sorting__binsearch = 0;

/* Implementation of 'tribeflow.sorting.binsearch' */
...
static char __pyx_k_tribeflow_sorting_binsearch[] = "tribeflow.sorting.binsearch";
static char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static char __pyx_k_home_mohame11_outlierDetection[] = "/home/mohame11/outlierDetection_gitRepo/Detecting-anomalies-in-user-trajectories/tribeflow/sorting/binsearch.pyx";
...
static PyObject *__pyx_n_s_tribeflow_sorting_binsearch;
static PyObject *__pyx_kp_s_unable_to_allocate_array_data;
static PyObject *__pyx_kp_s_unable_to_allocate_shape_and_str;
static PyObject *__pyx_n_s_unpack;
static PyObject *__pyx_n_s_value;
static PyObject *__pyx_pf_9tribeflow_7sorting_9binsearch__bsp(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_array, double __pyx_v_value); /* proto */
...
/* "tribeflow/sorting/binsearch.pyx":9
...
static int __pyx_f_9tribeflow_7sorting_9binsearch_bsp(double *__pyx_v_array, double __pyx_v_value, int __pyx_v_n) {
  int __pyx_v_lower;
  int __pyx_v_upper;
  int __pyx_v_half;
  int __pyx_v_idx;
  ...
  /* "tribeflow/sorting/binsearch.pyx":16
 *     '''
 * 
 *     cdef int lower = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "tribeflow/sorting/binsearch.pyx":17
 * 
 *     cdef int lower = 0
 *     cdef int upper = n - 1 #closed interval             # <<<<<<<<<<<<<<
 *     cdef int half = 0
 ...
 */
  ...
  /* "tribeflow/sorting/binsearch.pyx":18
 *     cdef int lower = 0
 *     cdef int upper = n - 1 #closed interval
 *     cdef int half = 0             # <<<<<<<<<<<<<<
 *     cdef int idx = -1
 ...
 */
  ...
  /* "tribeflow/sorting/binsearch.pyx":19
 *     cdef int upper = n - 1 #closed interval
 *     cdef int half = 0
 *     cdef int idx = -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "tribeflow/sorting/binsearch.pyx":21
 *     cdef int idx = -1
 * 
 *     while upper >= lower:             # <<<<<<<<<<<<<<
 ...
 */
  while (1) {
    ...
    /* "tribeflow/sorting/binsearch.pyx":22
 * 
 *     while upper >= lower:
 *         half = lower + ((upper - lower) // 2)             # <<<<<<<<<<<<<<
 *         if value == array[half]:
 ...
 */
    ...
    /* "tribeflow/sorting/binsearch.pyx":23
 *     while upper >= lower:
 *         half = lower + ((upper - lower) // 2)
 *         if value == array[half]:             # <<<<<<<<<<<<<<
 *             idx = half
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "tribeflow/sorting/binsearch.pyx":24
 *         half = lower + ((upper - lower) // 2)
 *         if value == array[half]:
 *             idx = half             # <<<<<<<<<<<<<<
 *             break
 ...
 */
      ...
      /* "tribeflow/sorting/binsearch.pyx":25
 *         if value == array[half]:
 *             idx = half
 *             break             # <<<<<<<<<<<<<<
 *         elif value > array[half]:
 ...
 */
    ...
    /* "tribeflow/sorting/binsearch.pyx":26
 *             idx = half
 *             break
 *         elif value > array[half]:             # <<<<<<<<<<<<<<
 *             lower = half + 1
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "tribeflow/sorting/binsearch.pyx":27
 *             break
 *         elif value > array[half]:
 *             lower = half + 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "tribeflow/sorting/binsearch.pyx":29
 *             lower = half + 1
 *         else:
 *             upper = half - 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "tribeflow/sorting/binsearch.pyx":31
 *             upper = half - 1
 * 
 *     if idx == -1: #Element not found, return where it should be             # <<<<<<<<<<<<<<
 *         idx = lower
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "tribeflow/sorting/binsearch.pyx":32
 * 
 *     if idx == -1: #Element not found, return where it should be
 *         idx = lower             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "tribeflow/sorting/binsearch.pyx":34
 *         idx = lower
 * 
 *     return idx             # <<<<<<<<<<<<<<
 * 
...
/* "tribeflow/sorting/binsearch.pyx":36
 *     return idx
 * 
 * def _bsp(double[::1] array, double value):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_9tribeflow_7sorting_9binsearch_1_bsp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_9tribeflow_7sorting_9binsearch_1_bsp = {"_bsp", (PyCFunction)__pyx_pw_9tribeflow_7sorting_9binsearch_1_bsp, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9tribeflow_7sorting_9binsearch_1_bsp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_bsp (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_array,&__pyx_n_s_value,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_value)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_bsp", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_bsp") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_array = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0]); if (unlikely(!__pyx_v_array.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_value = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_value == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_bsp", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("tribeflow.sorting.binsearch._bsp", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9tribeflow_7sorting_9binsearch__bsp(__pyx_self, __pyx_v_array, __pyx_v_value);
...
static PyObject *__pyx_pf_9tribeflow_7sorting_9binsearch__bsp(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_array, double __pyx_v_value) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_bsp", 0);

  /* "tribeflow/sorting/binsearch.pyx":37
 * 
 * def _bsp(double[::1] array, double value):
 *     return bsp(&array[0], value, array.shape[0])             # <<<<<<<<<<<<<<
 */
  ...
  __pyx_t_1 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_f_9tribeflow_7sorting_9binsearch_bsp((&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_array.data) + __pyx_t_1)) )))), __pyx_v_value, (__pyx_v_array.shape[0]))); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "tribeflow.sorting.binsearch.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "tribeflow.sorting.binsearch.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "tribeflow.sorting.binsearch.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "tribeflow.sorting.binsearch._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_tribeflow_sorting_binsearch, __pyx_k_tribeflow_sorting_binsearch, sizeof(__pyx_k_tribeflow_sorting_binsearch), 0, 0, 1, 1},
 ...
 *     return bsp(&array[0], value, array.shape[0])
 */
  __pyx_tuple__14 = PyTuple_Pack(2, __pyx_n_s_array, __pyx_n_s_value); if (unlikely(!__pyx_tuple__14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(2, 0, 2, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_mohame11_outlierDetection, __pyx_n_s_bsp, 36, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_tribeflow__sorting__binsearch) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "tribeflow.sorting.binsearch")) {
      if (unlikely(PyDict_SetItemString(modules, "tribeflow.sorting.binsearch", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("bsp", (void (*)(void))__pyx_f_9tribeflow_7sorting_9binsearch_bsp, "int (double *, double, int)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
 ...
 *     return bsp(&array[0], value, array.shape[0])
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9tribeflow_7sorting_9binsearch_1_bsp, NULL, __pyx_n_s_tribeflow_sorting_binsearch); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_bsp, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "tribeflow/sorting/binsearch.pyx":1
 * #-*- coding: utf8             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init tribeflow.sorting.binsearch", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init tribeflow.sorting.binsearch");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
