...
#define __PYX_HAVE__tribeflow__sorting__introsort
#define __PYX_HAVE_API__tribeflow__sorting__introsort
#include "math.h"
#include "pythread.h"
#include "string.h"
#include "stdlib.h"
...
static const char *__pyx_f[] = {
  "tribeflow/sorting/introsort.pyx",
  "stringsource",
};
...
static CYTHON_INLINE void __pyx_f_9tribeflow_7sorting_9introsort_swap(double *, int, int); /*proto*/
static CYTHON_INLINE double __pyx_f_9tribeflow_7sorting_9introsort_median3(double *, int); /*proto*/
static CYTHON_INLINE void __pyx_f_9tribeflow_7sorting_9introsort_introsort(double *, int, int); /*proto*/
static CYTHON_INLINE void __pyx_f_9tribeflow_7sorting_9introsort_sift_down(double *, int, int); /*proto*/
static void __pyx_f_9tribeflow_7sorting_9introsort_heapsort(double *, int); /*proto*/
...
#define __Pyx_MODULE_NAME "tribeflow.sorting.introsort"
int __pyx_module_is_main_tribeflow__sorting__introsort = 0;

/* Implementation of 'tribeflow.sorting.introsort' */
...
static char __pyx_k_sort[] = "_sort";
...
static char __pyx_k_tribeflow_sorting_introsort[] = "tribeflow.sorting.introsort";
static char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static char __pyx_k_home_mohame11_outlierDetection[] = "/home/mohame11/outlierDetection_gitRepo/Detecting-anomalies-in-user-trajectories/tribeflow/sorting/introsort.pyx";
...
static PyObject *__pyx_n_s_tribeflow_sorting_introsort;
static PyObject *__pyx_kp_s_unable_to_allocate_array_data;
static PyObject *__pyx_kp_s_unable_to_allocate_shape_and_str;
static PyObject *__pyx_n_s_unpack;
static PyObject *__pyx_pf_9tribeflow_7sorting_9introsort__sort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data); /* proto */
...
/* "tribeflow/sorting/introsort.pyx":18
...
static void __pyx_f_9tribeflow_7sorting_9introsort_sort(double *__pyx_v_data, int __pyx_v_n) {
  int __pyx_v_maxd;

  /* "tribeflow/sorting/introsort.pyx":19
 * # Algorithm: Introsort (Musser, SP&E, 1997).
 * cdef void sort(double *data, int n) nogil:
 *     cdef int maxd = 2 * <int>log(n)             # <<<<<<<<<<<<<<
 *     introsort(data, n, maxd)
 * 
 */
  __pyx_v_maxd = (2 * ((int)log(__pyx_v_n)));

  /* "tribeflow/sorting/introsort.pyx":20
 * cdef void sort(double *data, int n) nogil:
 *     cdef int maxd = 2 * <int>log(n)
 *     introsort(data, n, maxd)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_f_9tribeflow_7sorting_9introsort_introsort(__pyx_v_data, __pyx_v_n, __pyx_v_maxd);
...
/* "tribeflow/sorting/introsort.pyx":22
 *     introsort(data, n, maxd)
 * 
 * def _sort(double[::1] data):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_9tribeflow_7sorting_9introsort_1_sort(PyObject *__pyx_self, PyObject *__pyx_arg_data); /*proto*/
static PyMethodDef __pyx_mdef_9tribeflow_7sorting_9introsort_1_sort = {"_sort", (PyCFunction)__pyx_pw_9tribeflow_7sorting_9introsort_1_sort, METH_O, 0};
static PyObject *__pyx_pw_9tribeflow_7sorting_9introsort_1_sort(PyObject *__pyx_self, PyObject *__pyx_arg_data) {
  ...
  assert(__pyx_arg_data); {
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_arg_data); if (unlikely(!__pyx_v_data.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("tribeflow.sorting.introsort._sort", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9tribeflow_7sorting_9introsort__sort(__pyx_self, __pyx_v_data);
...
static PyObject *__pyx_pf_9tribeflow_7sorting_9introsort__sort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  Py_ssize_t __pyx_t_1;
  __Pyx_RefNannySetupContext("_sort", 0);

  /* "tribeflow/sorting/introsort.pyx":23
 * 
 * def _sort(double[::1] data):
 *     sort(&data[0], data.shape[0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = 0;
  __pyx_f_9tribeflow_7sorting_9introsort_sort((&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_data.data) + __pyx_t_1)) )))), (__pyx_v_data.shape[0]));
...
/* "tribeflow/sorting/introsort.pyx":25
 *     sort(&data[0], data.shape[0])
 * 
 * cdef inline void swap(double *data, int i, int j) nogil:             # <<<<<<<<<<<<<<
 *     # Helper for sort
...
static CYTHON_INLINE void __pyx_f_9tribeflow_7sorting_9introsort_swap(double *__pyx_v_data, int __pyx_v_i, int __pyx_v_j) {
  double __pyx_t_1;
  double __pyx_t_2;

  /* "tribeflow/sorting/introsort.pyx":27
 * cdef inline void swap(double *data, int i, int j) nogil:
 *     # Helper for sort
 *     data[i], data[j] = data[j], data[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = (__pyx_v_data[__pyx_v_j]);
  __pyx_t_2 = (__pyx_v_data[__pyx_v_i]);
  (__pyx_v_data[__pyx_v_i]) = __pyx_t_1;
  (__pyx_v_data[__pyx_v_j]) = __pyx_t_2;
...
/* "tribeflow/sorting/introsort.pyx":29
 *     data[i], data[j] = data[j], data[i]
 * 
 * cdef inline double median3(double *data, int n) nogil:             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE double __pyx_f_9tribeflow_7sorting_9introsort_median3(double *__pyx_v_data, int __pyx_v_n) {
  double __pyx_v_a;
  double __pyx_v_b;
  double __pyx_v_c;
  double __pyx_r;
  ...
  /* "tribeflow/sorting/introsort.pyx":32
 *     # Median of three pivot selection, after Bentley and McIlroy (1993).
 *     # Engineering a sort function. SP&E. Requires 8/3 comparisons on average.
 ...
 *         if b < c:
 */
  __pyx_v_a = (__pyx_v_data[0]);
  __pyx_v_b = (__pyx_v_data[(((long)__pyx_v_n) / 2)]);
  __pyx_v_c = (__pyx_v_data[(__pyx_v_n - 1)]);

  /* "tribeflow/sorting/introsort.pyx":33
 *     # Engineering a sort function. SP&E. Requires 8/3 comparisons on average.
 *     cdef double a = data[0], b = data[n / 2], c = data[n - 1]
 *     if a < b:             # <<<<<<<<<<<<<<
 *         if b < c:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "tribeflow/sorting/introsort.pyx":34
 *     cdef double a = data[0], b = data[n / 2], c = data[n - 1]
 *     if a < b:
 *         if b < c:             # <<<<<<<<<<<<<<
 *             return b
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "tribeflow/sorting/introsort.pyx":35
 *     if a < b:
 *         if b < c:
 *             return b             # <<<<<<<<<<<<<<
 *         elif a < c:
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":36
 *         if b < c:
 *             return b
 *         elif a < c:             # <<<<<<<<<<<<<<
 *             return c
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "tribeflow/sorting/introsort.pyx":37
 *             return b
 *         elif a < c:
 *             return c             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":39
 *             return c
 *         else:
 *             return a             # <<<<<<<<<<<<<<
 *     elif b < c:
 ...
 */
  ...
  /* "tribeflow/sorting/introsort.pyx":40
 *         else:
 *             return a
 *     elif b < c:             # <<<<<<<<<<<<<<
 *         if a < c:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "tribeflow/sorting/introsort.pyx":41
 *             return a
 *     elif b < c:
 *         if a < c:             # <<<<<<<<<<<<<<
 *             return a
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "tribeflow/sorting/introsort.pyx":42
 *     elif b < c:
 *         if a < c:
 *             return a             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":44
 *             return a
 *         else:
 *             return c             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "tribeflow/sorting/introsort.pyx":46
 *             return c
 *     else:
 *         return b             # <<<<<<<<<<<<<<
 * 
...
/* "tribeflow/sorting/introsort.pyx":50
 * # Introsort with median of 3 pivot selection and 3-way partition function
...
static CYTHON_INLINE void __pyx_f_9tribeflow_7sorting_9introsort_introsort(double *__pyx_v_data, int __pyx_v_n, int __pyx_v_maxd) {
  ...
  /* "tribeflow/sorting/introsort.pyx":54
 *     cdef int i, l, r
 * 
 *     while n > 1:             # <<<<<<<<<<<<<<
 ...
 */
  while (1) {
    ...
    /* "tribeflow/sorting/introsort.pyx":55
 * 
 *     while n > 1:
 *         if maxd <= 0:   # max depth limit exceeded ("gone quadratic")             # <<<<<<<<<<<<<<
 *             heapsort(data, n)
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "tribeflow/sorting/introsort.pyx":56
 *     while n > 1:
 *         if maxd <= 0:   # max depth limit exceeded ("gone quadratic")
 *             heapsort(data, n)             # <<<<<<<<<<<<<<
 *             return
 *         maxd -= 1
 */
      __pyx_f_9tribeflow_7sorting_9introsort_heapsort(__pyx_v_data, __pyx_v_n);

      /* "tribeflow/sorting/introsort.pyx":57
 *         if maxd <= 0:   # max depth limit exceeded ("gone quadratic")
 *             heapsort(data, n)
 *             return             # <<<<<<<<<<<<<<
 *         maxd -= 1
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":58
 *             heapsort(data, n)
 *             return
 *         maxd -= 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":60
 *         maxd -= 1
 * 
 *         pivot = median3(data, n)             # <<<<<<<<<<<<<<
 * 
 *         # Three-way partition.
 */
    __pyx_v_pivot = __pyx_f_9tribeflow_7sorting_9introsort_median3(__pyx_v_data, __pyx_v_n);

    /* "tribeflow/sorting/introsort.pyx":63
 * 
 *         # Three-way partition.
 *         i = l = 0             # <<<<<<<<<<<<<<
 *         r = n
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":64
 *         # Three-way partition.
 *         i = l = 0
 *         r = n             # <<<<<<<<<<<<<<
 *         while i < r:
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":65
 *         i = l = 0
 *         r = n
 *         while i < r:             # <<<<<<<<<<<<<<
 *             if data[i] < pivot:
 ...
 */
    while (1) {
      ...
      /* "tribeflow/sorting/introsort.pyx":66
 *         r = n
 *         while i < r:
 *             if data[i] < pivot:             # <<<<<<<<<<<<<<
 *                 swap(data, i, l)
 *                 i += 1
 */
      __pyx_t_1 = (((__pyx_v_data[__pyx_v_i]) < __pyx_v_pivot) != 0);
      if (__pyx_t_1) {

        /* "tribeflow/sorting/introsort.pyx":67
 *         while i < r:
 *             if data[i] < pivot:
 *                 swap(data, i, l)             # <<<<<<<<<<<<<<
 *                 i += 1
 *                 l += 1
 */
        __pyx_f_9tribeflow_7sorting_9introsort_swap(__pyx_v_data, __pyx_v_i, __pyx_v_l);

        /* "tribeflow/sorting/introsort.pyx":68
 *             if data[i] < pivot:
 *                 swap(data, i, l)
 *                 i += 1             # <<<<<<<<<<<<<<
 *                 l += 1
 ...
 */
        ...
        /* "tribeflow/sorting/introsort.pyx":69
 *                 swap(data, i, l)
 *                 i += 1
 *                 l += 1             # <<<<<<<<<<<<<<
 *             elif data[i] > pivot:
 ...
 */
      ...
      /* "tribeflow/sorting/introsort.pyx":70
 *                 i += 1
 *                 l += 1
 *             elif data[i] > pivot:             # <<<<<<<<<<<<<<
 *                 r -= 1
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "tribeflow/sorting/introsort.pyx":71
 *                 l += 1
 *             elif data[i] > pivot:
 *                 r -= 1             # <<<<<<<<<<<<<<
 *                 swap(data, i, r)
 ...
 */
        ...
        /* "tribeflow/sorting/introsort.pyx":72
 *             elif data[i] > pivot:
 *                 r -= 1
 *                 swap(data, i, r)             # <<<<<<<<<<<<<<
 *             else:
 *                 i += 1
 */
        __pyx_f_9tribeflow_7sorting_9introsort_swap(__pyx_v_data, __pyx_v_i, __pyx_v_r);
 ...
 */
      ...
      /* "tribeflow/sorting/introsort.pyx":74
 *                 swap(data, i, r)
 *             else:
 *                 i += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":76
 *                 i += 1
 * 
 *         introsort(data, l, maxd)             # <<<<<<<<<<<<<<
 *         data += r
 *         n -= r
 */
    __pyx_f_9tribeflow_7sorting_9introsort_introsort(__pyx_v_data, __pyx_v_l, __pyx_v_maxd);

    /* "tribeflow/sorting/introsort.pyx":77
 * 
 *         introsort(data, l, maxd)
 *         data += r             # <<<<<<<<<<<<<<
 *         n -= r
 * 
 */
    __pyx_v_data = (__pyx_v_data + __pyx_v_r);

    /* "tribeflow/sorting/introsort.pyx":78
 *         introsort(data, l, maxd)
 *         data += r
 *         n -= r             # <<<<<<<<<<<<<<
 * 
...
/* "tribeflow/sorting/introsort.pyx":80
 *         n -= r
 * 
 * cdef inline void sift_down(double *data, int start, int end) nogil:             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE void __pyx_f_9tribeflow_7sorting_9introsort_sift_down(double *__pyx_v_data, int __pyx_v_start, int __pyx_v_end) {
  int __pyx_v_child;
  int __pyx_v_maxind;
  int __pyx_v_root;
  int __pyx_t_1;
  ...
  /* "tribeflow/sorting/introsort.pyx":84
 *     cdef int child, maxind, root
 * 
 *     root = start             # <<<<<<<<<<<<<<
 *     while True:
 ...
 */
  ...
  /* "tribeflow/sorting/introsort.pyx":85
 * 
 *     root = start
 *     while True:             # <<<<<<<<<<<<<<
 *         child = root * 2 + 1
 ...
 */
  while (1) {
    ...
    /* "tribeflow/sorting/introsort.pyx":86
 *     root = start
 *     while True:
 *         child = root * 2 + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":89
 * 
 *         # find max of root, left child, right child
 *         maxind = root             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":90
 *         # find max of root, left child, right child
 *         maxind = root
 *         if child < end and data[maxind] <data[child]:             # <<<<<<<<<<<<<<
 *             maxind = child
 ...
 */
    ...
    __pyx_t_2 = (((__pyx_v_data[__pyx_v_maxind]) < (__pyx_v_data[__pyx_v_child])) != 0);
    __pyx_t_1 = __pyx_t_2;
    __pyx_L6_bool_binop_done:;
    if (__pyx_t_1) {

      /* "tribeflow/sorting/introsort.pyx":91
 *         maxind = root
 *         if child < end and data[maxind] <data[child]:
 *             maxind = child             # <<<<<<<<<<<<<<
 *         if child + 1 < end and data[maxind] <data[child + 1]:
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":92
 *         if child < end and data[maxind] <data[child]:
 *             maxind = child
 *         if child + 1 < end and data[maxind] <data[child + 1]:             # <<<<<<<<<<<<<<
 *             maxind = child + 1
 ...
 */
    ...
    __pyx_t_2 = (((__pyx_v_data[__pyx_v_maxind]) < (__pyx_v_data[(__pyx_v_child + 1)])) != 0);
    __pyx_t_1 = __pyx_t_2;
    __pyx_L9_bool_binop_done:;
    if (__pyx_t_1) {

      /* "tribeflow/sorting/introsort.pyx":93
 *             maxind = child
 *         if child + 1 < end and data[maxind] <data[child + 1]:
 *             maxind = child + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":95
 *             maxind = child + 1
 * 
 *         if maxind == root:             # <<<<<<<<<<<<<<
 *             break
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "tribeflow/sorting/introsort.pyx":96
 * 
 *         if maxind == root:
 *             break             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":98
 *             break
 *         else:
 *             swap(data, root, maxind)             # <<<<<<<<<<<<<<
 *             root = maxind
 ...
 */
    /*else*/ {
      __pyx_f_9tribeflow_7sorting_9introsort_swap(__pyx_v_data, __pyx_v_root, __pyx_v_maxind);

      /* "tribeflow/sorting/introsort.pyx":99
 *         else:
 *             swap(data, root, maxind)
 *             root = maxind             # <<<<<<<<<<<<<<
 * 
...
/* "tribeflow/sorting/introsort.pyx":101
 *             root = maxind
 * 
 * cdef void heapsort(double *data, int n) nogil:             # <<<<<<<<<<<<<<
 *     cdef int start, end
...
static void __pyx_f_9tribeflow_7sorting_9introsort_heapsort(double *__pyx_v_data, int __pyx_v_n) {
  int __pyx_v_start;
  int __pyx_v_end;
  int __pyx_t_1;

  /* "tribeflow/sorting/introsort.pyx":105
 * 
 *     # heapify
 *     start = (n - 2) / 2             # <<<<<<<<<<<<<<
 *     end = n
 ...
 */
  ...
  /* "tribeflow/sorting/introsort.pyx":106
 *     # heapify
 *     start = (n - 2) / 2
 *     end = n             # <<<<<<<<<<<<<<
 *     while True:
 ...
 */
  ...
  /* "tribeflow/sorting/introsort.pyx":107
 *     start = (n - 2) / 2
 *     end = n
 *     while True:             # <<<<<<<<<<<<<<
 *         sift_down(data, start, end)
 ...
 */
  while (1) {
    ...
    /* "tribeflow/sorting/introsort.pyx":108
 *     end = n
 *     while True:
 *         sift_down(data, start, end)             # <<<<<<<<<<<<<<
 *         if start == 0:
 *             break
 */
    __pyx_f_9tribeflow_7sorting_9introsort_sift_down(__pyx_v_data, __pyx_v_start, __pyx_v_end);

    /* "tribeflow/sorting/introsort.pyx":109
 *     while True:
 *         sift_down(data, start, end)
 *         if start == 0:             # <<<<<<<<<<<<<<
 *             break
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "tribeflow/sorting/introsort.pyx":110
 *         sift_down(data, start, end)
 *         if start == 0:
 *             break             # <<<<<<<<<<<<<<
 *         start -= 1
 ...
 */
    ...
    /* "tribeflow/sorting/introsort.pyx":111
 *         if start == 0:
 *             break
 *         start -= 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "tribeflow/sorting/introsort.pyx":114
 * 
 *     # sort by shrinking the heap, putting the max element immediately after it
 *     end = n - 1             # <<<<<<<<<<<<<<
 *     while end > 0:
 ...
 */
  ...
  /* "tribeflow/sorting/introsort.pyx":115
 *     # sort by shrinking the heap, putting the max element immediately after it
 *     end = n - 1
 *     while end > 0:             # <<<<<<<<<<<<<<
 *         swap(data, 0, end)
 ...
 */
  while (1) {
    ...
    /* "tribeflow/sorting/introsort.pyx":116
 *     end = n - 1
 *     while end > 0:
 *         swap(data, 0, end)             # <<<<<<<<<<<<<<
 *         sift_down(data, 0, end)
 *         end = end - 1
 */
    __pyx_f_9tribeflow_7sorting_9introsort_swap(__pyx_v_data, 0, __pyx_v_end);

    /* "tribeflow/sorting/introsort.pyx":117
 *     while end > 0:
 *         swap(data, 0, end)
 *         sift_down(data, 0, end)             # <<<<<<<<<<<<<<
 *         end = end - 1
 */
    __pyx_f_9tribeflow_7sorting_9introsort_sift_down(__pyx_v_data, 0, __pyx_v_end);

    /* "tribeflow/sorting/introsort.pyx":118
 *         swap(data, 0, end)
 *         sift_down(data, 0, end)
 *         end = end - 1             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "tribeflow.sorting.introsort.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "tribeflow.sorting.introsort.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "tribeflow.sorting.introsort.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "tribeflow.sorting.introsort._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_tribeflow_sorting_introsort, __pyx_k_tribeflow_sorting_introsort, sizeof(__pyx_k_tribeflow_sorting_introsort), 0, 0, 1, 1},
 ...
 * 
 */
  __pyx_tuple__14 = PyTuple_Pack(2, __pyx_n_s_data, __pyx_n_s_data); if (unlikely(!__pyx_tuple__14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(1, 0, 2, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_mohame11_outlierDetection, __pyx_n_s_sort, 22, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initintrosort(void); /*proto*/
PyMODINIT_FUNC initintrosort(void)
#else
PyMODINIT_FUNC PyInit_introsort(void); /*proto*/
PyMODINIT_FUNC PyInit_introsort(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_introsort(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("introsort", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_tribeflow__sorting__introsort) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "tribeflow.sorting.introsort")) {
      if (unlikely(PyDict_SetItemString(modules, "tribeflow.sorting.introsort", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("sort", (void (*)(void))__pyx_f_9tribeflow_7sorting_9introsort_sort, "void (double *, int)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9tribeflow_7sorting_9introsort_1_sort, NULL, __pyx_n_s_tribeflow_sorting_introsort); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_sort, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "tribeflow/sorting/introsort.pyx":1
 * #-*- coding: utf8             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init tribeflow.sorting.introsort", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init tribeflow.sorting.introsort");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
